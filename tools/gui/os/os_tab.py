...
def draw_os_tab(tab, oscfg):
    ...
    osekstd = ttk.Combobox(tab, width=27, textvariable=OS_StrVar[2])
    ...
    osekstd = ttk.Combobox(tab, width=27, textvariable=OS_StrVar[3])
    ...
    osekstd = ttk.Combobox(tab, width=27, textvariable=OS_StrVar[4])
    osekstd['values'] = ("FALSE", "TRUE")
    ...
    osekstd = ttk.Combobox(tab, width=27, textvariable=OS_StrVar[5])
    osekstd['values'] = ("FALSE", "TRUE")
    ...
    osekstd = ttk.Combobox(tab, width=27, textvariable=OS_StrVar[6])
    osekstd['values'] = ("FALSE", "TRUE")
    ...
    osekstd = ttk.Combobox(tab, width=27, textvariable=OS_StrVar[7])
    osekstd['values'] = ("FALSE", "TRUE")
    ...
    osekstd = ttk.Combobox(tab, width=27, textvariable=OS_StrVar[8])
    osekstd['values'] = ("FALSE", "TRUE")
    ...
    osekstd = ttk.Combobox(tab, width=27, textvariable=OS_StrVar[9])
    osekstd['values'] = ("FALSE", "TRUE")
    ...
    osekstd = ttk.Combobox(tab, width=27, textvariable=OS_StrVar[10])
    osekstd['values'] = ("FALSE", "TRUE")
    ...
    label.grid(row=14, column=1, sticky="w")
    textb = tk.Entry(tab, text="Entry", width=30, textvariable=OS_StrVar[14])
